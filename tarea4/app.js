...
function mostrarMenu() {
    ...
    menu += (productos.length + 2) + ". Agregar artículo de venta\n";
...
// Función para agregar articulos nuevos a comprar
function agregarArticulo() {
    ...
    if (isNaN(precio) || precio <= 0) {
        console.log("El precio ingresado no es válido. Debe ser un número real mayor a 0.");
        return;
    }

    // Agregar el nuevo producto a la lista de productos
    productos.push({ nombre: nombre, precio: precio });
    console.log("Producto" + nombre + " con precio $" + precio + " agregado a la lista de productos.");
}
